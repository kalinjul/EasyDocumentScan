            ...
            extensions.configure<PublishingExtension> {
                publications.withType<MavenPublication> {
                    ...
                    pom {
                        ...
                        url.set("https://github.com/kalinjul/EasyDocumentScan")
                        licenses {
                            license {
                            ...
                            scm {
                                connection.set("scm:git:github.com/kalinjul/EasyDocumentScan.git")
                                developerConnection.set("scm:git:ssh://github.com/kalinjul/EasyDocumentScan.git")
                                url.set("https://github.com/kalinjul/EasyDocumentScan/tree/main")
                            }
                        }
                    }
                }
